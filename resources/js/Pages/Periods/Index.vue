<template>
    <app-layout title="Предметы">
        <v-card class="mb-5">
            <v-card-title>Панель управления годами обучения</v-card-title>
            <v-card-text class="d-flex justify-space-between align-center">
                <div>
                    <span class="d-block">
                        Администраторы могут создавать, редактировать года обучения.
                    </span>
                    <span class="d-block red--text">
                        Внимание удалять года обучения могут только администраторы, так как это может повлиять на всю систему!
                    </span>
                </div>
            </v-card-text>
        </v-card>
